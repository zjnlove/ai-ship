  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-0">
        <div className="bg-primary/5 absolute top-1/3 left-0 h-96 w-96 rounded-full blur-3xl" />
      </div>
                ...
                <div className="relative" key={idx}>
                  <div className="text-center">
                    ...
                    <div className="relative mx-auto mb-8">
                      <div className="bg-primary mx-auto flex h-16 w-16 items-center justify-center rounded-full shadow-xl">
