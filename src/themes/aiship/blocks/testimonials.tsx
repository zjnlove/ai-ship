...
export function Testimonials({
  ...
  const TestimonialCard = ({
    ...
    return (
      <div
        className={cn(
          'group card-hover hover:border-primary/50 border-primary/30 relative flex flex-col gap-4 rounded-2xl border bg-white/5 p-6 backdrop-blur-sm transition-all duration-300 hover:bg-white/10',
          isLarge && 'row-span-2 p-8',
          isMedium && 'p-7'
        )}
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <h3 className="text-foreground text-sm font-bold">{item.name}</h3>
              {/* 认证图标 */}
              <svg
